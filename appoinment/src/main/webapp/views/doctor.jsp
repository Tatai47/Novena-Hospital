            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <div class="section-title">
                        ...
                        <p>Meet our highly qualified and experienced medical professionals, dedicated to providing
                            compassionate and comprehensive care for you and your family.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row shuffle-wrapper portfolio-gallery">
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="[&quot;cat2&quot;]">
                    <div class="position-relative doctor-inner-box">
                        ...
                        <div class="content mt-3">
                            <h4 class="mb-0"><a href="doctor-single">Harrison Samuel</a></h4>
                            <p>Radiology</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="[&quot;cat3&quot;]">
                    <div class="position-relative doctor-inner-box">
                        ...
                        <div class="content mt-3">
                            <h4 class="mb-0"><a href="doctor-single">Alexander James</a></h4>
                            <p>Dental</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item" data-groups="[&quot;cat4&quot;]">
                    <div class="position-relative doctor-inner-box">
                        ...
                        <div class="content mt-3">
                            <h4 class="mb-0"><a href="doctor-single">Thomas Alexander</a></h4>
                            <p>Cardiology</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6 col-md-6 mb-4 shuffle-item"
                    ...
                    <div class="position-relative doctor-inner-box">
                        ...
                        <div class="content mt-3">
                            <h4 class="mb-0"><a href="doctor-single">Harrison Thomas </a></h4>
                            <p>Traumatology</p>
                        </div>
                    </div>
                </div>
